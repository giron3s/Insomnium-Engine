...
void nvgBeginFrame(NVGcontext* ctx, int UIWindowWidth, int UIWindowHeight, float devicePixelRatio)
{
/*	printf("Tris: draws:%d  fill:%d  stroke:%d  text:%d  TOT:%d\n",
	...
	ctx->params.renderViewport(ctx->params.userPtr, UIWindowWidth, UIWindowHeight, devicePixelRatio);
