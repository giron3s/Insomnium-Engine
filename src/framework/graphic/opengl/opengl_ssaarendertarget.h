...
namespace Framework
{
    ...
    {
      public:
        ~OpenGLSSAARenderTarget() override;
        bool Init(uint32_t aWidth, uint32_t aHeight, uint32_t aFactor, uint32_t aNumTargets = 1);
        ...
        bool Blit() { return Blit(0, 0, mWidth / mFactor, mHeight / mFactor); }
        void Clear();
      ...
      private:
        ...
        uint32_t mFactor; /**< Factor for the internal size of the SSAA framebuffer */
    };
}
