...
namespace Framework
{
    namespace GUI
    {
        ...
        */
        class UITheme : public UIObject
        {
        public:
            UITheme(NVGcontext *ctx);
            UITheme(NVGcontext* ctx, std::string aThemeFile);

            static Color ParseColor(std::string aColorString);
            static std::string SerializeColor(Color aColor);

            void Serialize(Json::Value& aSerializer);
            ...
            */
            ...
            ///  Fonts for various UI elements. Can be modified by custom themes.
            std::string mLabelFont;
            std::string mButtonFont;
            std::string mHeadingFont;
            std::string mTextboxFont;
            std::string mTabHeadingFont;
        ...
        class CustomTheme : public UITheme {
        public:
