...
namespace Framework
{
    namespace GUI
    {
        ...
        */
        class UIColorPicker : public UIPopupButton 
        {
        public:
            ...
            */
            UIColorPicker(UIWidget *parent, const Color& color = Color(1.0f, 0.0f, 0.0f, 1.0f));
