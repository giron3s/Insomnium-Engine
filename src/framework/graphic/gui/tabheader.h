...
namespace Framework
{
    namespace GUI
    {
        ...
        */
        class UITabHeader : public UIWidget
        {
        public:
            UITabHeader(UIWidget *parent, const std::string &font = "sans-bold");
        ...
        private:
            ...
            */
            ...
            public:
                ...
                UITabButton(UITabHeader& aHeader, const std::string& aLabel);
                ...
                void drawActiveBorderAt(NVGcontext * ctx, const glm::ivec2& position, float offset, const Color& color);
                void drawInactiveBorderAt(NVGcontext * ctx, const glm::ivec2& position, float offset, const Color& color);
            ...
            using TabIterator = std::vector<UITabButton>::iterator;
            using ConstTabIterator = std::vector<UITabButton>::const_iterator;
            ...
            ClickLocation locateClick(const glm::ivec2& p);
            void onArrowLeft();
            void onArrowRight();

            std::function<void(int)> mCallback;
            std::vector<UITabButton> mTabButtons;
            int mVisibleStart = 0;
            int mVisibleEnd = 0;
            int mActiveTab = 0;
