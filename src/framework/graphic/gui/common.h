    ...
    namespace GUI
    {
        ...
        */
        ...
        public:
            ...
            */
            Color(const glm::vec4 &aColor) : mColor(aColor.r, aColor.g, aColor.b, aColor.a) { }
            ...
            */
            Color(float intensity, float alpha)
                : Color(glm::vec3(intensity), alpha) { }
            ...
            */
            Color(int intensity, int alpha)
                : Color(glm::ivec3(intensity), alpha) { }
            ...
            * The alpha component of the color, will be divided by ``255.0``.
            */
            Color(int r, int g, int b, int a) : Color(glm::ivec4(r, g, b, a)) { }
            ...
            Color& operator*(int aMultiplier)
            {
                float lMultiplier = static_cast<float>(aMultiplier);
                mColor.r = mColor.r * lMultiplier;
                mColor.g = mColor.g * lMultiplier;
                mColor.b = mColor.b * lMultiplier;
                mColor.a = mColor.a * lMultiplier;

                return *this;
            }

            Color& operator*(float aMultiplier)
            {
                mColor.r = mColor.r * aMultiplier;
                mColor.g = mColor.g * aMultiplier;
                mColor.b = mColor.b * aMultiplier;
                mColor.a = mColor.a * aMultiplier;
            ...
            {
                mColor.r = mColor.r * aColor.r();
                mColor.g = mColor.g * aColor.g();
                mColor.b = mColor.b * aColor.b();
                mColor.a = mColor.a * aColor.a();
                return *this;
            }
            ...
            */
            ...
            {
                glm::vec4 lColor(0.299f, 0.587f, 0.144f, 0.f);
                glm::vec4 lWiseProduct = lColor * mColor;

                float lLuminance = lWiseProduct.r + lWiseProduct.g + lWiseProduct.b + lWiseProduct.a;
                return Color(lLuminance < 0.5f ? 1.f : 0.f, 1.f);
            }

            /// Allows for conversion between this Color and NanoVG's representation.
            inline operator const NVGcolor &() const;

            inline operator const glm::vec4&() const { return mColor; }
            //public:
         ...
         * \endrst
         */
        extern NANOGUI_EXPORT void Initialize();
