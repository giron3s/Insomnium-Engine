    ...
    namespace GUI
    {
        ...
        */
        ...
        public:
            ...
            UITextBox(UIWidget *aParent, const std::string &aValue = "@UNTITLED");
            ...
            std::string getPasswordValue(std::string aValue);
        ...
        protected:
            ...
            SpinArea spinArea(const glm::ivec2 & pos);
        ...
        */
        ...
        public:
            UIIntBox(UIWidget *parent, Scalar value = (Scalar)0)
                : UITextBox(parent)
            {
                setDefaultValue("0");
            ...
            Scalar value() const
            {
                std::istringstream iss(UITextBox::value());
                Scalar value = 0;
                iss >> value;
                return value;
            }
            ...
            void setValue(Scalar value)
            {
                ...
                UITextBox::setValue(std::to_string(clampedValue));
            }
            ...
            virtual bool mouseButtonEvent(const glm::ivec2 &p, int button, bool down, int modifiers) override
            {
                ...
                return UITextBox::mouseButtonEvent(p, button, down, modifiers);
            }

            virtual bool mouseDragEvent(const glm::ivec2 &p, const glm::ivec2 &rel, int button, int modifiers) override
            {
                if (UITextBox::mouseDragEvent(p, rel, button, modifiers))
                {
                    return true;
                }
        ...
        */
        ...
        {
        public:
            UIFloatBox(UIWidget *parent, Scalar value = (Scalar) 0.f)
                : UITextBox(parent)
            {
            ...
            Scalar value() const
            {
                return (Scalar)std::stod(UITextBox::value());
            }
            ...
            void setCallback(const std::function<void(Scalar)> &cb)
            {
                UITextBox::setCallback([cb, this](const std::string &str) {
